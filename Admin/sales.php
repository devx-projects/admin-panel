          ...
          <?php
           ...
           $sql = "SELECT  *FROM product";
            $result = mysqli_query($conn, $sql);
              ...
              echo "['".$row['name']."',".$row['price'].",".$row['pid']."],"; 
              }
          ...
          <div class="row">
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 sidebar fixed-top">
              ...
              <ul class="navbar-nav flex-column mt-4">
                ...
                <li class="nav-item"><a href="sales.php" class="nav-link text-white p-3 mb-2 current"><i class="fas fa-shopping-cart text-light fa-lg mr-3"></i>Sales</a></li>
                ...
                <li class="nav-item"><a href="Employe.php" class="nav-link text-white p-3 mb-2 sidebar-link"><i class="fas fa-chart-line text-light fa-lg mr-3"></i>Employe</a></li>     </ul>
            </div>
            <!-- end of sidebar -->
            ...
            <div class="col-xl-10 col-lg-9 col-md-8 ml-auto bg-dark fixed-top py-2 top-navbar">
              <div class="row align-items-center">
                <div class="col-md-4">
                  <h4 class="text-light text-uppercase mb-0">Sales</h4> <!--  Name phase -->
                </div>
                <div class="col-md-5">
                  <form>
