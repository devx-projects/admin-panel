          ...
          <div class="row">
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 sidebar fixed-top">
              ...
              <ul class="navbar-nav flex-column mt-4">
                <li class="nav-item"><a href="Admin.php" method="post" class="nav-link text-white p-3 mb-2 current"><i class="fas fa-home text-light fa-lg mr-3"></i>Dashboard</a></li>
            ...
            <div class="col-xl-10 col-lg-9 col-md-8 ml-auto bg-dark fixed-top py-2 top-navbar">
              <div class="row align-items-center">
                <div class="col-md-4">
                  <h4 class="text-light text-uppercase mb-0">Dashboard</h4> <!--  Name phase -->
                </div>
                <div class="col-md-5">
                  <form>
                ...
                <div class="col-md-3">
                  ...
                  <li class="nav-item icon-parent ml-md-auto"><a href="#" class="nav-link" data-toggle="modal" data-target="#sign-out" class="nav-link icon-bullet"><i class="fas fa-users-cog text-danger"></i></i></a></li>
                    <li class="nav-item ml-md-auto"><a href="page1.php"><i class="fas fa-sign-out-alt text-danger fa-lg"></i></a></li>
                  </ul>
                </div>
              </div>
            </div>
        ...
        <div class="row">
          <div class="col-xl-10 col-lg-9 col-md-8 ml-auto">
            <div class="row pt-md-5 mt-md-3 mb-5">
              <div class="col-xl-6 col-sm-6 p-3">
                <div class="card card-common">
                  ...
                  <div class="card-footer text-secondary" >
                    ...
                    <a href="Product.php"> <span class="text-dark">Updated Now</span></a>
                  </div>
                </div>
              </div>
              <div class="col-xl-6 col-sm-6 p-3">
                <div class="card card-common">
                  ...
                  <div class="card-footer text-secondary">
                    ...
                    <a href="sales.php"> <span class="text-dark">Updated Now</span></a>
                  </div>
                </div>
              </div>
              <div class="col-xl-6 col-sm-6 p-3">
                <div class="card card-common">
                  ...
                  <div class="card-footer text-secondary">
                    ...
                    <a href="Customer.php"> <span class="text-dark">Updated Now</span></a>
                  </div>
                </div>
              </div>
              <div class="col-xl-6 col-sm-6 p-3">
                <div class="card card-common">
                  ...
                  <div class="card-footer text-secondary">
                    ...
                    <a href="Employe.php"> <span class="text-dark">Updated Now</span></a>
                  </div>
                </div>
              </div>
            </div>
