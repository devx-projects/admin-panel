          ...
          <div class="row">
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 sidebar fixed-top">
              ...
              <ul class="navbar-nav flex-column mt-4">
                ...
                <li class="nav-item"><a href="Product.php" class="nav-link text-white p-3 mb-2  current"><i class="fas fa-user text-light fa-lg mr-3"></i>Product</a></li>
            ...
            <div class="col-xl-10 col-lg-9 col-md-8 ml-auto bg-dark fixed-top py-2 top-navbar">
              <div class="row align-items-center">
                <div class="col-md-4">
                  <h4 class="text-light text-uppercase mb-0">Product</h4> <!--  Name phase -->
                </div>
                <div class="col-md-5">
                  <form>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body"  >
              ...
              <br>
              <textarea name="description" id="" cols="50" rows="3" placeholder="Description " required></textarea>
              <br><br>
